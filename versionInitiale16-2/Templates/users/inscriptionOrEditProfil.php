<form method="post" action="">
    <fieldset>
        ...
        <div class="mb-3">
            ...
            <input type="password" placeholder="Mot de passe" class="form-control" id="Password" name="txtMp" value="">
        </div>
        <div>
            <button name="btnEnvoi" class="btn btn-primary" value="inscrire">Envoyer</button>
        </div>
    </fieldset>
</form>
